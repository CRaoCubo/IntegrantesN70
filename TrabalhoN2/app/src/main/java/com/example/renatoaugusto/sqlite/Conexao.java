...
public class Conexao extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_CREATE =
            "create table compromissos (codigo integer primary key autoincrement, nome text not null, data text not null, local text not null, descricao text not null, participantes text not null, cancelado integer not null);";
